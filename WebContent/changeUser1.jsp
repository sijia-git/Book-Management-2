				...
				<form id="f1" action="UserServlet?action=updateTouxaing"
					...
					<div class="form-group">
						<label class="col-sm-3 col-sm-offset-2 control-label text-info">
							<img src="/img${s.touxiang }" width="80" height="80">
						</label>
						...
						<div class="col-sm-4  f1input2">
							<input type="submit" value="确认修改头像" class="btn " />
						</div>
					</div>
				</form>
		  
				<form id="f2" action="UserServlet?action=updateUserTx"
					method="post" class="form-horizontal f2">
