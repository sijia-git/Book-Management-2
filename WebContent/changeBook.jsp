	...
	<div class="col col-md-5 col-md-offset-2" id="div1">
		...
		<form action="BookServlet?action=update2" method="post" id="fm"
			...
			<div class="form-group">
				<label class="col-sm-3 col-sm-offset-2 control-label text-info">图书ID:</label>
				<div class="col-sm-6"><input type="text" name="id" value="${fl.id }" class="form-control input-sm"/>	</div>
			</div>
	<!-- 		<div class="form-group">
				<label class="col-sm-3 col-sm-offset-2 control-label text-info">页码:</label>
				<div class="col-sm-6"><input type="text" name="pageNew" value="${pageNew }"  class="form-control input-sm"/>	</div>
			</div><!--  -->
			...
			<div class="form-group">
				<label class="col-sm-3 col-sm-offset-2 control-label text-info">新分类:</label>
				<div class="col-sm-6">
				...
				<div class="col-sm-6"><input type="text" name="name"
							value="${fl.name }" class="form-control input-sm"/>	</div>
			</div>
					<div class="form-group">
				<label class="col-sm-3 col-sm-offset-2 control-label text-info">图书价格:</label>
				<div class="col-sm-6"><input type="text" name="money" value="${fl.money }" class="form-control input-sm"/>	</div>
			</div>
					<div class="form-group">
				<label class="col-sm-3 col-sm-offset-2 control-label text-info">出版社:</label>
				<div class="col-sm-6"><input type="text" name="press" value="${fl.press }" class="form-control input-sm"/>	</div>
			</div>
				 
			<div class="form-group ">
			<label class="col-sm-3 col-sm-offset-2 control-label text-info">图书状态:</label>
				<div class="col-sm-6"><input type="text" name="state" value="${fl.state }" class="form-control input-sm"/>	</div>
			</div>
				...
				<div class="form-group">
				<label class="col-sm-3 col-sm-offset-2 control-label text-info">读者:</label>
				<div class="col-sm-6"><input type="text"   name="reader"
