...
<script>
	...
	window.onload = function() {
		...
		var outAll=document.getElementById("outAll");//拿到按钮
		outAll.onclick = function() { //为其绑定一个单击事件
        ...
        <div class="container-fluid " id="div2">  
			<table id="t"    cellspacing="0" cellpadding="0">
				<tr height="8%">
					...
					<font size="5" color="#337AB7" face="宋体"><strong>读者列表</strong></font><br>
					 </td>
				</tr>
