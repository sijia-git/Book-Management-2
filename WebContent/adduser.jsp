...
<body >
	...
	<h1 class="text-center text-info">添加读者</h1>
             <hr >
			<table    >
				<tr>
					<td valign="top" width="60%">
						<form name="register" action="UserServlet?action=add"
							...
							<div class="form-group">
								<label class="col-sm-3 col-sm-offset-2 control-label text-info">登录密码:</label>
								<div class="col-sm-6">
									<input type="text" name="password"   class="form-control input-sm"/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 col-sm-offset-2 control-label text-info">电话号码:</label>
								<div class="col-sm-6">
