...
<body>
	...
	<div class="container-fluid" id="div9">
		...
		<div class="col col-md-5 col-md-offset-2" id="div1">
				...
				<h1 class="text-center text-info">修改读者信息</h1>
				<hr>
				<form id="f1" action="UserServlet?action=updateTouxaing"
					...
					<div class="form-group">
						<label class="col-sm-3 col-sm-offset-2 control-label text-info">
							<img src="/img${s.touxiang }" width="100" height="100">
						</label>
						<div class="col-sm-6 f1input1">
							<input type="file" name="touxiang" class="form-control input-sm" />
						</div>
					 
						<div class="col-sm-6  f1input2">
				...
				<form id="f2" action="UserServlet?action=updateUser"  method="post" class="form-horizontal">	
				  ...
				  <div class="form-group">
				<label class="col-sm-3 col-sm-offset-2 control-label text-info">读者ID:</label>
				<div class="col-sm-6"><input type="text" name="id" value="${s.id }" class="form-control input-sm"/>	</div>
			</div>			 
					<div class="form-group">
					...
					<div class="form-group">
						<label class="col-sm-3 col-sm-offset-2 control-label text-info">昵&nbsp;&nbsp;&nbsp;&nbsp;称:</label>
						<div class="col-sm-6">
					...
					<div class="form-group">
						<label class="col-sm-3 col-sm-offset-2 control-label text-info">联系方式:</label>
						<div class="col-sm-6">
