	...
	<div class="container-fluid"  id="div9">
		<!--  <marquee align="texttop" behavior="slide" scrollamount="60"
			...
			<div class="col col-md-5 col-md-offset-2" id="div1">
				...
				<h1 class="text-center text-info">添加借阅</h1>
             <hr >
				<form action="LendServlet?action=add" method="post" name="register"
					...
					<div class="form-group">
						<label class="col-sm-3 control-label col-sm-offset-2 text-info">价格:</label>
						<div class="col-sm-5">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label col-sm-offset-2 text-info">借书时间:</label>
						<div class="col-sm-5">
							<input type="text" name="lend_time"   class="form-control input-sm" />
							</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label col-sm-offset-2 text-info">还书时间:</label>
						<div class="col-sm-5">
							<input type="text" name="back_time"   class="form-control input-sm" />
						</div>
					</div>			
					<div class="form-group">
