...
<div class="container-fluid" id="div9">
	...
	<table > 
		<tr  >
			<td  > 
		 <form   class="form-horizontal" action="FenleiServlet?action=update&pageNew=${pageNew}" method="post" >
				 <div class="form-group">
				<label class="col-sm-3 col-sm-offset-2 control-label text-info">分类ID:</label>
				<div class="col-sm-4"><input type="text" name="id" value="${fl.id }" class="form-control input-sm"/>	</div>
			</div>
